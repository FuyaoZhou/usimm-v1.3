...
// Definitions for extern variables from params.h and memory_controller.h
int NUMCORES;
...
int cas_issued_current_cycle[MAX_NUM_CHANNELS][MAX_NUM_RANKS][MAX_NUM_BANKS];
